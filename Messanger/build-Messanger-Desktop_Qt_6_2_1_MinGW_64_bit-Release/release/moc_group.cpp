...
#include <memory>
#include "../../Messanger/widget/group.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Group_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Group_t qt_meta_stringdata_Group = {
    {
QT_MOC_LITERAL(0, 5) // "Group"
...
const QMetaObject Group::staticMetaObject = { {
    ...
    qt_meta_stringdata_Group.offsetsAndSize,
    qt_meta_data_Group,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Group_t
