...
#include <memory>
#include "../../Messanger/widget/accountwidget.h"
...
struct qt_meta_stringdata_AccountWidget_t {
    const uint offsetsAndSize[2];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AccountWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_AccountWidget_t qt_meta_stringdata_AccountWidget = {
    {
...
static const uint qt_meta_data_AccountWidget[] = {
...
const QMetaObject AccountWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<ChatReceiver::staticMetaObject>(),
    qt_meta_stringdata_AccountWidget.offsetsAndSize,
    qt_meta_data_AccountWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AccountWidget_t
...
void *AccountWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AccountWidget.stringdata0))
